...
from main.utils import sms_utils
...
class LoginViewSet(viewsets.ViewSet):
    ...
    def request_code(self, request, *args, **kwargs):
        ...
        sms_utils.send_code(serializer.data['phone_number'], auth_code)
    ...
    def submit_code(self, request, *args, **kwargs):
        ...
        if received_auth_code != actual_auth_code:
            raise ValidationError("کد تایید اشتباه است!", code=HTTP_400_BAD_REQUEST)
